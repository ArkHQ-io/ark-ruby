...
module ArkEmail
  module Models
    class TenantUsageTimeseries < ArkEmail::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(ArkEmail::TenantUsageTimeseries, ArkEmail::Internal::AnyHash)
        end

      # Array of time-bucketed data points
      sig { returns(T::Array[ArkEmail::TenantUsageTimeseries::Data]) }
      attr_accessor :data

      # Time bucket granularity
      sig do
        returns(ArkEmail::TenantUsageTimeseries::Granularity::TaggedSymbol)
      end
      ...
      sig do
        params(
          data: T::Array[ArkEmail::TenantUsageTimeseries::Data::OrHash],
          granularity: ArkEmail::TenantUsageTimeseries::Granularity::OrSymbol,
      ...
      sig do
        override.returns(
          {
            data: T::Array[ArkEmail::TenantUsageTimeseries::Data],
            granularity:
              ArkEmail::TenantUsageTimeseries::Granularity::TaggedSymbol,
      ...
      class Data < ArkEmail::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ArkEmail::TenantUsageTimeseries::Data,
      ...
      module Granularity
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, ArkEmail::TenantUsageTimeseries::Granularity)
          end
        ...
        sig do
          override.returns(
            T::Array[ArkEmail::TenantUsageTimeseries::Granularity::TaggedSymbol]
          )
        end
        def self.values
        end
