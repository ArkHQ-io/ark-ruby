...
module ArkEmail
  module Models
    class WebhookCreateResponse < ArkEmail::Internal::Type::BaseModel
      ...
      sig { returns(ArkEmail::Models::WebhookCreateResponse::Data) }
      attr_reader :data

      sig do
        params(data: ArkEmail::Models::WebhookCreateResponse::Data::OrHash).void
      end
      attr_writer :data
      ...
      sig do
        params(
          data: ArkEmail::Models::WebhookCreateResponse::Data::OrHash,
      ...
      class Data < ArkEmail::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ArkEmail::Models::WebhookCreateResponse::Data,
              ArkEmail::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            ...
            events:
              T::Array[
                ArkEmail::Models::WebhookCreateResponse::Data::Event::OrSymbol
              ],
            name: String,
            url: String,
            uuid: String
        ...
        module Event
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                ArkEmail::Models::WebhookCreateResponse::Data::Event
              )
            end
