    ...
    module Tenants
      class TrackingVerifyResponse < ArkEmail::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ArkEmail::Models::Tenants::TrackingVerifyResponse,
              ArkEmail::Internal::AnyHash
            )
          end

        sig { returns(ArkEmail::Models::Tenants::TrackingVerifyResponse::Data) }
        attr_reader :data

        sig do
          params(
            data:
              ArkEmail::Models::Tenants::TrackingVerifyResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < ArkEmail::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                ArkEmail::Models::Tenants::TrackingVerifyResponse::Data,
                ArkEmail::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                ArkEmail::Models::Tenants::TrackingVerifyResponse::Data::DNSStatus::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              dns_record:
                T.nilable(
                  ArkEmail::Models::Tenants::TrackingVerifyResponse::Data::DNSRecord::OrHash
                )
            ).void
          end
          ...
          sig do
            params(
              ...
              dns_status:
                T.nilable(
                  ArkEmail::Models::Tenants::TrackingVerifyResponse::Data::DNSStatus::OrSymbol
                ),
              full_name: String,
          ...
          module DNSStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ArkEmail::Models::Tenants::TrackingVerifyResponse::Data::DNSStatus
                )
              end
