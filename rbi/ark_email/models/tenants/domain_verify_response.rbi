    ...
    module Tenants
      class DomainVerifyResponse < ArkEmail::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ArkEmail::Models::Tenants::DomainVerifyResponse,
              ArkEmail::Internal::AnyHash
            )
          end

        sig { returns(ArkEmail::Models::Tenants::DomainVerifyResponse::Data) }
        attr_reader :data

        sig do
          params(
            data: ArkEmail::Models::Tenants::DomainVerifyResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < ArkEmail::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                ArkEmail::Models::Tenants::DomainVerifyResponse::Data,
                ArkEmail::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              dns_records:
                T.nilable(
                  ArkEmail::Models::Tenants::DomainVerifyResponse::Data::DNSRecords::OrHash
                )
            ).void
          end
