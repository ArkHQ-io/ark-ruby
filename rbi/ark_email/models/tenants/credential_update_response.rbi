  ...
  module Models
    module Tenants
      class CredentialUpdateResponse < ArkEmail::Internal::Type::BaseModel
        ...
        sig do
          returns(ArkEmail::Models::Tenants::CredentialUpdateResponse::Data)
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              ArkEmail::Models::Tenants::CredentialUpdateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < ArkEmail::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                ArkEmail::Models::Tenants::CredentialUpdateResponse::Data,
                ArkEmail::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              ArkEmail::Models::Tenants::CredentialUpdateResponse::Data::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              ...
              name: String,
              type:
                ArkEmail::Models::Tenants::CredentialUpdateResponse::Data::Type::OrSymbol,
              updated_at: Time,
              key: String,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  ArkEmail::Models::Tenants::CredentialUpdateResponse::Data::Type
                )
              end
