  ...
  module Models
    module Tenants
      class SuppressionRetrieveResponse < ArkEmail::Internal::Type::BaseModel
        ...
        sig do
          returns(ArkEmail::Models::Tenants::SuppressionRetrieveResponse::Data)
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              ArkEmail::Models::Tenants::SuppressionRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data:
                ArkEmail::Models::Tenants::SuppressionRetrieveResponse::Data,
