    ...
    module Tenants
      class DomainRetrieveResponse < ArkEmail::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              ArkEmail::Models::Tenants::DomainRetrieveResponse,
              ArkEmail::Internal::AnyHash
            )
          end

        sig { returns(ArkEmail::Models::Tenants::DomainRetrieveResponse::Data) }
        attr_reader :data

        sig do
          params(
            data:
              ArkEmail::Models::Tenants::DomainRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < ArkEmail::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                ArkEmail::Models::Tenants::DomainRetrieveResponse::Data,
                ArkEmail::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              dns_records:
                T.nilable(
                  ArkEmail::Models::Tenants::DomainRetrieveResponse::Data::DNSRecords::OrHash
                )
            ).void
          end
          ...
          class DNSRecords < ArkEmail::Internal::Type::BaseModel
            ...
            sig { returns(T.nilable(ArkEmail::Tenants::DNSRecord)) }
            attr_reader :dkim

            sig do
              params(dkim: T.nilable(ArkEmail::Tenants::DNSRecord::OrHash)).void
            end
            attr_writer :dkim
            ...
            sig do
              params(
                return_path: T.nilable(ArkEmail::Tenants::DNSRecord::OrHash)
              ).void
            end
            ...
            sig do
              params(spf: T.nilable(ArkEmail::Tenants::DNSRecord::OrHash)).void
            end
            attr_writer :spf
            ...
            sig do
              params(
                dkim: T.nilable(ArkEmail::Tenants::DNSRecord::OrHash),
                return_path: T.nilable(ArkEmail::Tenants::DNSRecord::OrHash),
                spf: T.nilable(ArkEmail::Tenants::DNSRecord::OrHash),
                zone: String
              ).returns(T.attached_class)
            end
            def self.new(
            ...
            sig do
              override.returns(
                {
                  dkim: T.nilable(ArkEmail::Tenants::DNSRecord),
                  return_path: T.nilable(ArkEmail::Tenants::DNSRecord),
                  spf: T.nilable(ArkEmail::Tenants::DNSRecord),
                  zone: String
                }
              )
            end
