    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: ArkEmail::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  ArkEmail::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(ArkEmail::Internal::Type::Converter::Input)
                  }
                )
              ]
            )
          ...
          sig do
            params(
              ...
              spec: ArkEmail::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: ArkEmail::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: ArkEmail::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: ArkEmail::Internal::Type::BaseModel,
              convert: T::Boolean
        ...
        sig { overridable.returns(ArkEmail::Internal::AnyHash) }
        def to_h
        end
