    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(
            data:
              T.any(Ark::Internal::AnyHash, T::Array[T.anything], T.anything),
            pick:
              T.nilable(
                T.any(
                  Symbol,
      ...
      class << self
        ...
        # @api private
        sig do
          params(parsed: Ark::Internal::Util::ParsedUri).returns(URI::Generic)
        end
        ...
        sig do
          params(
            lhs: Ark::Internal::Util::ParsedUri,
            rhs: Ark::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Ark::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type: T.any(Ark::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end
