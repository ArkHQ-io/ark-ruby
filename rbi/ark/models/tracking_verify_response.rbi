...
module Ark
  module Models
    class TrackingVerifyResponse < Ark::Internal::Type::BaseModel
      ...
      sig do
        returns(Ark::Models::TrackingVerifyResponse::Success::TaggedBoolean)
      end
      ...
      sig do
        params(
          ...
          success: Ark::Models::TrackingVerifyResponse::Success::OrBoolean
        ...
        override.returns(
          {
            ...
            meta: Ark::APIMeta,
            success: Ark::Models::TrackingVerifyResponse::Success::TaggedBoolean
          }
        )
      end
      def to_hash
      ...
      module Success
        ...
        TaggedBoolean =
          T.type_alias do
            T.all(T::Boolean, Ark::Models::TrackingVerifyResponse::Success)
          end
        ...
        TRUE =
          T.let(
            true,
            Ark::Models::TrackingVerifyResponse::Success::TaggedBoolean
          )
