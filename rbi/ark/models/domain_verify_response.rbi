...
module Ark
  module Models
    class DomainVerifyResponse < Ark::Internal::Type::BaseModel
      ...
      sig { returns(Ark::Models::DomainVerifyResponse::Success::TaggedBoolean) }
      ...
      sig do
        params(
          ...
          success: Ark::Models::DomainVerifyResponse::Success::OrBoolean
        ...
        override.returns(
          {
            ...
            meta: Ark::APIMeta,
            success: Ark::Models::DomainVerifyResponse::Success::TaggedBoolean
          }
        )
      end
      def to_hash
      ...
      module Success
        ...
        TaggedBoolean =
          T.type_alias do
            T.all(T::Boolean, Ark::Models::DomainVerifyResponse::Success)
          end
        OrBoolean = T.type_alias { T::Boolean }

        TRUE =
          T.let(true, Ark::Models::DomainVerifyResponse::Success::TaggedBoolean)

        sig do
          override.returns(
            T::Array[Ark::Models::DomainVerifyResponse::Success::TaggedBoolean]
          )
        end
        def self.values
        end
