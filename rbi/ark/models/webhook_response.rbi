...
module Ark
  module Models
    class WebhookResponse < Ark::Internal::Type::BaseModel
      ...
      sig { returns(Ark::WebhookResponse::Success::TaggedBoolean) }
      ...
      sig do
        params(
          ...
          success: Ark::WebhookResponse::Success::OrBoolean
        ...
        override.returns(
          {
            ...
            meta: Ark::APIMeta,
            success: Ark::WebhookResponse::Success::TaggedBoolean
          }
        )
      end
      def to_hash
      ...
      module Success
        ...
        TaggedBoolean =
          T.type_alias { T.all(T::Boolean, Ark::WebhookResponse::Success) }
        OrBoolean = T.type_alias { T::Boolean }

        TRUE = T.let(true, Ark::WebhookResponse::Success::TaggedBoolean)

        sig do
          override.returns(
            T::Array[Ark::WebhookResponse::Success::TaggedBoolean]
          )
        end
        def self.values
        end
