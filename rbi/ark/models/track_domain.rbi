...
module Ark
  module Models
    class TrackDomain < Ark::Internal::Type::BaseModel
      OrHash = T.type_alias { T.any(Ark::TrackDomain, Ark::Internal::AnyHash) }
      ...
      sig { returns(T.nilable(Ark::TrackDomain::DNSRecord)) }
      attr_reader :dns_record

      sig do
        params(dns_record: T.nilable(Ark::TrackDomain::DNSRecord::OrHash)).void
      end
      attr_writer :dns_record

      # Current DNS verification status
      sig { returns(T.nilable(Ark::TrackDomain::DNSStatus::TaggedSymbol)) }
      ...
      sig do
        params(
          ...
          dns_record: T.nilable(Ark::TrackDomain::DNSRecord::OrHash),
          dns_status: T.nilable(Ark::TrackDomain::DNSStatus::OrSymbol),
        ...
        override.returns(
          {
            ...
            dns_checked_at: T.nilable(Time),
            dns_error: T.nilable(String),
            dns_record: T.nilable(Ark::TrackDomain::DNSRecord),
            dns_status: T.nilable(Ark::TrackDomain::DNSStatus::TaggedSymbol),
            excluded_click_domains: T.nilable(String),
            updated_at: T.nilable(Time)
          }
        )
      ...
      class DNSRecord < Ark::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Ark::TrackDomain::DNSRecord, Ark::Internal::AnyHash)
          end
      ...
      module DNSStatus
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Ark::TrackDomain::DNSStatus) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        OK = T.let(:ok, Ark::TrackDomain::DNSStatus::TaggedSymbol)
        MISSING = T.let(:missing, Ark::TrackDomain::DNSStatus::TaggedSymbol)
        INVALID = T.let(:invalid, Ark::TrackDomain::DNSStatus::TaggedSymbol)

        sig do
          override.returns(T::Array[Ark::TrackDomain::DNSStatus::TaggedSymbol])
        end
        def self.values
        end
      end
