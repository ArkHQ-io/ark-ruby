...
module Ark
  module Models
    class EmailSendRawResponse < Ark::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Ark::Models::EmailSendRawResponse, Ark::Internal::AnyHash)
        end

      sig { returns(Ark::Models::EmailSendRawResponse::Data) }
      attr_reader :data

      sig { params(data: Ark::Models::EmailSendRawResponse::Data::OrHash).void }
      attr_writer :data
      ...
      class Data < Ark::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Ark::Models::EmailSendRawResponse::Data,
        ...
        sig do
          returns(Ark::Models::EmailSendRawResponse::Data::Status::TaggedSymbol)
        end
        ...
        sig do
          params(
            id: String,
            status: Ark::Models::EmailSendRawResponse::Data::Status::OrSymbol,
            to: T::Array[String],
            message_id: String
          ).returns(T.attached_class)
        end
          ...
          override.returns(
            {
              id: String,
              status:
                Ark::Models::EmailSendRawResponse::Data::Status::TaggedSymbol,
              to: T::Array[String],
              message_id: String
            }
          )
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Ark::Models::EmailSendRawResponse::Data::Status)
            end
