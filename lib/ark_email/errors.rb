  ...
  module Errors
    ...
    class APIStatusError < ArkEmail::Errors::APIError
      ...
      def self.for(url:, status:, headers:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          ArkEmail::Errors::BadRequestError.new(**kwargs)
        in 401
          ArkEmail::Errors::AuthenticationError.new(**kwargs)
        in 403
          ArkEmail::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          ArkEmail::Errors::NotFoundError.new(**kwargs)
        in 409
          ArkEmail::Errors::ConflictError.new(**kwargs)
        in 422
          ArkEmail::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          ArkEmail::Errors::RateLimitError.new(**kwargs)
        in (500..)
          ArkEmail::Errors::InternalServerError.new(**kwargs)
        else
          ArkEmail::Errors::APIStatusError.new(**kwargs)
        end
      end
