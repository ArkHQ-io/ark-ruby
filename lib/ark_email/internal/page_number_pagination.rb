  ...
  module Internal
    ...
    class PageNumberPagination
      ...
      def next_page
        ...
        req = ArkEmail::Internal::Util.deep_merge(@req, {query: {page: (page || 1).to_i.succ}})
        @client.request(req)
      end
      ...
      def initialize(client:, req:, headers:, page_data:)
        ...
        case page_data
        in {data: Array => data}
          @data = data.map { ArkEmail::Internal::Type::Converter.coerce(@model, _1) }
        else
        end
        @page = page_data[:page]
        ...
        in {meta: Hash | nil => meta}
          @meta = ArkEmail::Internal::Type::Converter.coerce(
            ArkEmail::Internal::PageNumberPagination::Meta,
            meta
          )
        else
        end
