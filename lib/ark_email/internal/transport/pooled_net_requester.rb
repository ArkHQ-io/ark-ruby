      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - ArkEmail::Internal::Util.monotonic_secs
        ...
        private def with_pool(url, deadline:, &blk)
          origin = ArkEmail::Internal::Util.uri_origin(url)
          timeout = deadline - ArkEmail::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise ArkEmail::Errors::APITimeoutError.new(url: url, request: req)
          rescue StandardError
            raise ArkEmail::Errors::APIConnectionError.new(url: url, request: req)
          end
          # rubocop:enable Metrics/BlockLength

          _, response = enum.next
          body = ArkEmail::Internal::Util.fused_enum(enum, external: true) do
            finished = true
            loop { enum.next }
          end
