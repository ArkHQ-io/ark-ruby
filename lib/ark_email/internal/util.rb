    ...
    module Util
      ...
      class << self
          ...
          strio = writable_enum do |y|
            ...
            in Hash
              body.each do |key, val|
                case val
                in Array if val.all? { primitive?(_1) || ArkEmail::Internal::Type::FileInput === _1 }
                  val.each do |v|
        ...
        def encode_content(headers, body)
          ...
          in [ArkEmail::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [ArkEmail::Internal::Util::JSONL_CONTENT, Enumerable] unless ArkEmail::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | ArkEmail::Internal::Type::FileInput]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in ArkEmail::Internal::Util::JSON_CONTENT
          ...
          in ArkEmail::Internal::Util::JSONL_CONTENT
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [ArkEmail::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in ArkEmail::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
