...
module ArkEmail
  module Internal
    module Type
      ...
      # `ArkEmail::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | ArkEmail::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= ArkEmail::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              ArkEmail::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? ArkEmail::FilePart.new(value, filename: "upload") : value
            in ArkEmail::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
          ...
          # @return [Object]
          def to_sorbet_type
            T.any(Pathname, StringIO, IO, String, ArkEmail::FilePart)
          end
        end
      end
    end
