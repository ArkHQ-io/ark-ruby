    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { ArkEmail::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { ArkEmail::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            ArkEmail::FilePart.new(value)
          in ArkEmail::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in ArkEmail::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [ArkEmail::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: ArkEmail::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in ArkEmail::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in ArkEmail::Internal::Type::Converter
              ...
              ArkEmail::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(ArkEmail::Internal::Type::Converter, T::Class[T.anything]) }
        end
