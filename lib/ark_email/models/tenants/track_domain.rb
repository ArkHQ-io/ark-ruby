  ...
  module Models
    module Tenants
      class TrackDomain < ArkEmail::Internal::Type::BaseModel
        ...
        #
        #   @return [ArkEmail::Models::Tenants::TrackDomain::DNSRecord, nil]
        optional :dns_record,
                 -> {
        ...
        #
        #   @return [Symbol, ArkEmail::Models::Tenants::TrackDomain::DNSStatus, nil]
        optional :dns_status,
                 enum: -> { ArkEmail::Tenants::TrackDomain::DNSStatus },
                 api_name: :dnsStatus,
                 nil?: true
        ...
        #   {ArkEmail::Models::Tenants::TrackDomain} for more details.
        #
        ...
        #
        #   @param dns_record [ArkEmail::Models::Tenants::TrackDomain::DNSRecord, nil] Required DNS record configuration
        #
        #   @param dns_status [Symbol, ArkEmail::Models::Tenants::TrackDomain::DNSStatus, nil] Current DNS verification status
        #
        ...
        # Current DNS verification status
        #
        # @see ArkEmail::Models::Tenants::TrackDomain#dns_status
        module DNSStatus
