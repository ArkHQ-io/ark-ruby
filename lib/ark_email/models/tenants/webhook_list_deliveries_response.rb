  ...
  module Models
    module Tenants
      ...
      class WebhookListDeliveriesResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<ArkEmail::Models::Tenants::WebhookListDeliveriesResponse::Data>]
        required :data,
                 -> { ArkEmail::Internal::Type::ArrayOf[ArkEmail::Models::Tenants::WebhookListDeliveriesResponse::Data] }
        ...
        #
        #   @param data [Array<ArkEmail::Models::Tenants::WebhookListDeliveriesResponse::Data>]
        #
        ...
        class Data < ArkEmail::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, ArkEmail::Models::Tenants::WebhookListDeliveriesResponse::Data::Event]
          required :event, enum: -> { ArkEmail::Models::Tenants::WebhookListDeliveriesResponse::Data::Event }
          ...
          #
          #   @param event [Symbol, ArkEmail::Models::Tenants::WebhookListDeliveriesResponse::Data::Event] Event type that triggered this delivery
          #
          ...
          # Event type that triggered this delivery
          #
          # @see ArkEmail::Models::Tenants::WebhookListDeliveriesResponse::Data#event
          module Event
