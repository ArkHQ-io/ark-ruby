...
module ArkEmail
  module Models
    module Tenants
      # @see ArkEmail::Resources::Tenants::Webhooks#create
      class WebhookCreateResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Tenants::WebhookCreateResponse::Data]
        required :data, -> { ArkEmail::Models::Tenants::WebhookCreateResponse::Data }
        ...
        #   @param data [ArkEmail::Models::Tenants::WebhookCreateResponse::Data]
        #   @param meta [ArkEmail::Models::APIMeta]
        #   @param success [Boolean, true]

        # @see ArkEmail::Models::Tenants::WebhookCreateResponse#data
        class Data < ArkEmail::Internal::Type::BaseModel
          ...
          #   Subscribed events
          #
          #   @return [Array<Symbol, ArkEmail::Models::Tenants::WebhookCreateResponse::Data::Event>]
          required :events,
                   -> { ArkEmail::Internal::Type::ArrayOf[enum: ArkEmail::Models::Tenants::WebhookCreateResponse::Data::Event] }
          ...
          #
          #   @param events [Array<Symbol, ArkEmail::Models::Tenants::WebhookCreateResponse::Data::Event>] Subscribed events
          #
