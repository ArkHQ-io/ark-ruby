...
module ArkEmail
  module Models
    module Tenants
      ...
      class CredentialUpdateResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Tenants::CredentialUpdateResponse::Data]
        required :data, -> { ArkEmail::Models::Tenants::CredentialUpdateResponse::Data }
        ...
        #   @param data [ArkEmail::Models::Tenants::CredentialUpdateResponse::Data]
        #   @param meta [ArkEmail::Models::APIMeta]
        #   @param success [Boolean, true]

        # @see ArkEmail::Models::Tenants::CredentialUpdateResponse#data
        class Data < ArkEmail::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, ArkEmail::Models::Tenants::CredentialUpdateResponse::Data::Type]
          required :type, enum: -> { ArkEmail::Models::Tenants::CredentialUpdateResponse::Data::Type }
          ...
          #   {ArkEmail::Models::Tenants::CredentialUpdateResponse::Data} for more details.
          #
          ...
          #
          #   @param type [Symbol, ArkEmail::Models::Tenants::CredentialUpdateResponse::Data::Type] Type of credential:
          #
          ...
          # - `api` - For API-based email sending
          #
          # @see ArkEmail::Models::Tenants::CredentialUpdateResponse::Data#type
          module Type
