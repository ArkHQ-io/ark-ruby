  ...
  module Models
    module Tenants
      ...
      class WebhookCreateParams < ArkEmail::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Symbol, ArkEmail::Models::Tenants::WebhookCreateParams::Event>, nil]
        optional :events,
                 -> {
                   ArkEmail::Internal::Type::ArrayOf[enum: ArkEmail::Tenants::WebhookCreateParams::Event]
                 },
                 nil?: true
