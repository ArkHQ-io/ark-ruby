  ...
  module Models
    module Tenants
      ...
      class WebhookTestResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Tenants::WebhookTestResponse::Data]
        required :data, -> { ArkEmail::Models::Tenants::WebhookTestResponse::Data }
        ...
        #   @param data [ArkEmail::Models::Tenants::WebhookTestResponse::Data]
        #   @param meta [ArkEmail::Models::APIMeta]
        #   @param success [Boolean, true]

        # @see ArkEmail::Models::Tenants::WebhookTestResponse#data
