...
module ArkEmail
  module Models
    module Tenants
      # @see ArkEmail::Resources::Tenants::Domains#verify
      class DomainVerifyResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Tenants::DomainVerifyResponse::Data]
        required :data, -> { ArkEmail::Models::Tenants::DomainVerifyResponse::Data }
        ...
        #   @param data [ArkEmail::Models::Tenants::DomainVerifyResponse::Data]
        #   @param meta [ArkEmail::Models::APIMeta]
        #   @param success [Boolean, true]

        # @see ArkEmail::Models::Tenants::DomainVerifyResponse#data
        class Data < ArkEmail::Internal::Type::BaseModel
          ...
          #
          #   @return [ArkEmail::Models::Tenants::DomainVerifyResponse::Data::DNSRecords, nil]
          required :dns_records,
                   -> { ArkEmail::Models::Tenants::DomainVerifyResponse::Data::DNSRecords },
                   api_name: :dnsRecords,
                   nil?: true
          ...
          #   {ArkEmail::Models::Tenants::DomainVerifyResponse::Data} for more details.
          #
          #   @param id [Integer] Unique domain identifier
          #
          #   @param created_at [Time] Timestamp when the domain was added
          #
          #   @param dns_records [ArkEmail::Models::Tenants::DomainVerifyResponse::Data::DNSRecords, nil] DNS records that must be added to your domain's DNS settings. Null if records ar
          #
          ...
          # @see ArkEmail::Models::Tenants::DomainVerifyResponse::Data#dns_records
          class DNSRecords < ArkEmail::Internal::Type::BaseModel
            ...
            #
            #   @return [ArkEmail::Models::Tenants::DNSRecord, nil]
            optional :dkim, -> { ArkEmail::Tenants::DNSRecord }, nil?: true
            ...
            #
            #   @return [ArkEmail::Models::Tenants::DNSRecord, nil]
            optional :return_path, -> { ArkEmail::Tenants::DNSRecord }, api_name: :returnPath, nil?: true
            ...
            #
            #   @return [ArkEmail::Models::Tenants::DNSRecord, nil]
            optional :spf, -> { ArkEmail::Tenants::DNSRecord }, nil?: true
            ...
            #   Some parameter documentations has been truncated, see
            #   {ArkEmail::Models::Tenants::DomainVerifyResponse::Data::DNSRecords} for more
            #   details.
            #
            #   DNS records that must be added to your domain's DNS settings. Null if records
            #   are not yet generated.
            ...
            #   - Return Path `name` would be `psrp.mail`
            #
            #   @param dkim [ArkEmail::Models::Tenants::DNSRecord, nil] A DNS record that needs to be configured in your domain's DNS settings.
            #
            #   @param return_path [ArkEmail::Models::Tenants::DNSRecord, nil] A DNS record that needs to be configured in your domain's DNS settings.
            #
            #   @param spf [ArkEmail::Models::Tenants::DNSRecord, nil] A DNS record that needs to be configured in your domain's DNS settings.
            #
