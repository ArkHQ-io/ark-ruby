...
module ArkEmail
  module Models
    module Tenants
      # @see ArkEmail::Resources::Tenants::Webhooks#update
      class WebhookUpdateResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Tenants::WebhookUpdateResponse::Data]
        required :data, -> { ArkEmail::Models::Tenants::WebhookUpdateResponse::Data }
        ...
        #   @param data [ArkEmail::Models::Tenants::WebhookUpdateResponse::Data]
        #   @param meta [ArkEmail::Models::APIMeta]
        #   @param success [Boolean, true]

        # @see ArkEmail::Models::Tenants::WebhookUpdateResponse#data
        class Data < ArkEmail::Internal::Type::BaseModel
          ...
          #   Subscribed events
          #
          #   @return [Array<Symbol, ArkEmail::Models::Tenants::WebhookUpdateResponse::Data::Event>]
          required :events,
                   -> { ArkEmail::Internal::Type::ArrayOf[enum: ArkEmail::Models::Tenants::WebhookUpdateResponse::Data::Event] }
          ...
          #
          #   @param events [Array<Symbol, ArkEmail::Models::Tenants::WebhookUpdateResponse::Data::Event>] Subscribed events
          #
