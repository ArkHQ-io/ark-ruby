  ...
  module Models
    module Tenants
      ...
      class DomainCreateResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Tenants::DomainCreateResponse::Data]
        ...
        # @see ArkEmail::Models::Tenants::DomainCreateResponse#data
        class Data < ArkEmail::Internal::Type::BaseModel
          ...
          #
          #   @return [ArkEmail::Models::Tenants::DomainCreateResponse::Data::DNSRecords, nil]
          required :dns_records,
                   -> { ArkEmail::Models::Tenants::DomainCreateResponse::Data::DNSRecords },
                   api_name: :dnsRecords,
                   nil?: true
          ...
          #   {ArkEmail::Models::Tenants::DomainCreateResponse::Data} for more details.
          #
          #   @param id [Integer] Unique domain identifier
          #
          #   @param created_at [Time] Timestamp when the domain was added
          #
          #   @param dns_records [ArkEmail::Models::Tenants::DomainCreateResponse::Data::DNSRecords, nil] DNS records that must be added to your domain's DNS settings. Null if records ar
          #
          ...
          # @see ArkEmail::Models::Tenants::DomainCreateResponse::Data#dns_records
          class DNSRecords < ArkEmail::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {ArkEmail::Models::Tenants::DomainCreateResponse::Data::DNSRecords} for more
            #   details.
            #
            #   DNS records that must be added to your domain's DNS settings. Null if records
            #   are not yet generated.
