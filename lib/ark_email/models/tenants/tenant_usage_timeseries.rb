  ...
  module Models
    module Tenants
      class TenantUsageTimeseries < ArkEmail::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<ArkEmail::Models::Tenants::TenantUsageTimeseries::Data>]
        required :data, -> { ArkEmail::Internal::Type::ArrayOf[ArkEmail::Tenants::TenantUsageTimeseries::Data] }

        # @!attribute granularity
        #   Time bucket granularity
        #
        #   @return [Symbol, ArkEmail::Models::Tenants::TenantUsageTimeseries::Granularity]
        required :granularity, enum: -> { ArkEmail::Tenants::TenantUsageTimeseries::Granularity }
        ...
        #
        #   @param data [Array<ArkEmail::Models::Tenants::TenantUsageTimeseries::Data>] Array of time-bucketed data points
        #
        #   @param granularity [Symbol, ArkEmail::Models::Tenants::TenantUsageTimeseries::Granularity] Time bucket granularity
        #
        ...
        # Time bucket granularity
        #
        # @see ArkEmail::Models::Tenants::TenantUsageTimeseries#granularity
        module Granularity
