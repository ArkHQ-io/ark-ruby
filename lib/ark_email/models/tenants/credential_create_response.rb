  ...
  module Models
    module Tenants
      ...
      class CredentialCreateResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Tenants::CredentialCreateResponse::Data]
        required :data, -> { ArkEmail::Models::Tenants::CredentialCreateResponse::Data }
        ...
        #   @param data [ArkEmail::Models::Tenants::CredentialCreateResponse::Data]
        #   @param meta [ArkEmail::Models::APIMeta]
        #   @param success [Boolean, true]

        # @see ArkEmail::Models::Tenants::CredentialCreateResponse#data
        class Data < ArkEmail::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, ArkEmail::Models::Tenants::CredentialCreateResponse::Data::Type]
          required :type, enum: -> { ArkEmail::Models::Tenants::CredentialCreateResponse::Data::Type }
          ...
          # @!method initialize(id:, created_at:, hold:, key:, last_used_at:, name:, type:, updated_at:, smtp_username: nil)
          #   Some parameter documentations has been truncated, see
          #   {ArkEmail::Models::Tenants::CredentialCreateResponse::Data} for more details.
          #
          ...
          #
          #   @param key [String] The credential key (secret). **Store this securely** - it will
          #
          #   @param last_used_at [Time, nil] When the credential was last used to send an email
          #
          #   @param name [String] Name of the credential
          #
          #   @param type [Symbol, ArkEmail::Models::Tenants::CredentialCreateResponse::Data::Type] Type of credential:
          #
          ...
          # - `api` - For API-based email sending
          #
          # @see ArkEmail::Models::Tenants::CredentialCreateResponse::Data#type
          module Type
