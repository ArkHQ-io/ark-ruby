  ...
  module Models
    module Tenants
      class DNSRecord < ArkEmail::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, ArkEmail::Models::Tenants::DNSRecord::Type]
        required :type, enum: -> { ArkEmail::Tenants::DNSRecord::Type }
        ...
        #
        #   @return [Symbol, ArkEmail::Models::Tenants::DNSRecord::Status, nil]
        optional :status, enum: -> { ArkEmail::Tenants::DNSRecord::Status }, nil?: true

        # @!method initialize(full_name:, name:, type:, value:, status: nil)
        #   Some parameter documentations has been truncated, see
        #   {ArkEmail::Models::Tenants::DNSRecord} for more details.
        #
        ...
        #
        #   @param type [Symbol, ArkEmail::Models::Tenants::DNSRecord::Type] The DNS record type to create
        #
        #   @param value [String] The value to set for the DNS record
        #
        #   @param status [Symbol, ArkEmail::Models::Tenants::DNSRecord::Status, nil] Current verification status of this DNS record:

        # The DNS record type to create
        #
        # @see ArkEmail::Models::Tenants::DNSRecord#type
        module Type
        ...
        # - `null` - Record has not been checked yet
        #
        # @see ArkEmail::Models::Tenants::DNSRecord#status
        module Status
          extend ArkEmail::Internal::Type::Enum
