  ...
  module Models
    module Tenants
      ...
      class DomainRetrieveResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Tenants::DomainRetrieveResponse::Data]
        required :data, -> { ArkEmail::Models::Tenants::DomainRetrieveResponse::Data }
        ...
        #   @param data [ArkEmail::Models::Tenants::DomainRetrieveResponse::Data]
        #   @param meta [ArkEmail::Models::APIMeta]
        #   @param success [Boolean, true]

        # @see ArkEmail::Models::Tenants::DomainRetrieveResponse#data
        class Data < ArkEmail::Internal::Type::BaseModel
          ...
          #
          #   @return [ArkEmail::Models::Tenants::DomainRetrieveResponse::Data::DNSRecords, nil]
          required :dns_records,
                   -> { ArkEmail::Models::Tenants::DomainRetrieveResponse::Data::DNSRecords },
                   api_name: :dnsRecords,
                   nil?: true
          ...
          #   {ArkEmail::Models::Tenants::DomainRetrieveResponse::Data} for more details.
          #
          #   @param id [Integer] Unique domain identifier
          #
          #   @param created_at [Time] Timestamp when the domain was added
          #
          #   @param dns_records [ArkEmail::Models::Tenants::DomainRetrieveResponse::Data::DNSRecords, nil] DNS records that must be added to your domain's DNS settings. Null if records ar
          #
          ...
          # @see ArkEmail::Models::Tenants::DomainRetrieveResponse::Data#dns_records
          class DNSRecords < ArkEmail::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {ArkEmail::Models::Tenants::DomainRetrieveResponse::Data::DNSRecords} for more
            #   details.
            #
            #   DNS records that must be added to your domain's DNS settings. Null if records
            #   are not yet generated.
