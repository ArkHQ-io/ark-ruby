...
module ArkEmail
  module Models
    module Tenants
      # @see ArkEmail::Resources::Tenants::Domains#list
      class DomainListResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Tenants::DomainListResponse::Data]
        required :data, -> { ArkEmail::Models::Tenants::DomainListResponse::Data }
        ...
        #   @param data [ArkEmail::Models::Tenants::DomainListResponse::Data]
        #   @param meta [ArkEmail::Models::APIMeta]
        #   @param success [Boolean, true]

        # @see ArkEmail::Models::Tenants::DomainListResponse#data
        class Data < ArkEmail::Internal::Type::BaseModel
          # @!attribute domains
          #
          #   @return [Array<ArkEmail::Models::Tenants::DomainListResponse::Data::Domain>]
          required :domains,
                   -> { ArkEmail::Internal::Type::ArrayOf[ArkEmail::Models::Tenants::DomainListResponse::Data::Domain] }

          # @!method initialize(domains:)
          #   @param domains [Array<ArkEmail::Models::Tenants::DomainListResponse::Data::Domain>]
          ...
          class Domain < ArkEmail::Internal::Type::BaseModel
            ...
            #   {ArkEmail::Models::Tenants::DomainListResponse::Data::Domain} for more details.
            #
