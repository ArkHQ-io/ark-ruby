...
module ArkEmail
  module Models
    ...
    class WebhookCreateResponse < ArkEmail::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [ArkEmail::Models::WebhookCreateResponse::Data]
      required :data, -> { ArkEmail::Models::WebhookCreateResponse::Data }
      ...
      #   @param data [ArkEmail::Models::WebhookCreateResponse::Data]
      #   @param meta [ArkEmail::Models::APIMeta]
      #   @param success [Boolean, true]

      # @see ArkEmail::Models::WebhookCreateResponse#data
      class Data < ArkEmail::Internal::Type::BaseModel
        ...
        #   Subscribed events
        #
        #   @return [Array<Symbol, ArkEmail::Models::WebhookCreateResponse::Data::Event>]
        required :events,
                 -> { ArkEmail::Internal::Type::ArrayOf[enum: ArkEmail::Models::WebhookCreateResponse::Data::Event] }
        ...
        #
        #   @param events [Array<Symbol, ArkEmail::Models::WebhookCreateResponse::Data::Event>] Subscribed events
        #
