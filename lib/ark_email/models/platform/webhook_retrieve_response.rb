...
module ArkEmail
  module Models
    module Platform
      # @see ArkEmail::Resources::Platform::Webhooks#retrieve
      class WebhookRetrieveResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Platform::WebhookRetrieveResponse::Data]
        required :data, -> { ArkEmail::Models::Platform::WebhookRetrieveResponse::Data }
        ...
        #   @param data [ArkEmail::Models::Platform::WebhookRetrieveResponse::Data]
        #   @param meta [ArkEmail::Models::APIMeta]
        #   @param success [Boolean, true]

        # @see ArkEmail::Models::Platform::WebhookRetrieveResponse#data
        class Data < ArkEmail::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Symbol, ArkEmail::Models::Platform::WebhookRetrieveResponse::Data::Event>]
          required :events,
                   -> { ArkEmail::Internal::Type::ArrayOf[enum: ArkEmail::Models::Platform::WebhookRetrieveResponse::Data::Event] }
          ...
          #
          #   @param events [Array<Symbol, ArkEmail::Models::Platform::WebhookRetrieveResponse::Data::Event>] Subscribed events (empty = all events)
          #
