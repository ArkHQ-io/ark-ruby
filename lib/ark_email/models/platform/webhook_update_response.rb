  ...
  module Models
    module Platform
      ...
      class WebhookUpdateResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Platform::WebhookUpdateResponse::Data]
        required :data, -> { ArkEmail::Models::Platform::WebhookUpdateResponse::Data }
        ...
        #   @param data [ArkEmail::Models::Platform::WebhookUpdateResponse::Data]
        #   @param meta [ArkEmail::Models::APIMeta]
        #   @param success [Boolean, true]

        # @see ArkEmail::Models::Platform::WebhookUpdateResponse#data
        class Data < ArkEmail::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Symbol, ArkEmail::Models::Platform::WebhookUpdateResponse::Data::Event>]
          required :events,
                   -> { ArkEmail::Internal::Type::ArrayOf[enum: ArkEmail::Models::Platform::WebhookUpdateResponse::Data::Event] }
          ...
          #
          #   @param events [Array<Symbol, ArkEmail::Models::Platform::WebhookUpdateResponse::Data::Event>] Subscribed events (empty = all events)
          #
