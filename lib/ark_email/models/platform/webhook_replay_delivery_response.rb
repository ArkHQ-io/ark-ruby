...
module ArkEmail
  module Models
    module Platform
      # @see ArkEmail::Resources::Platform::Webhooks#replay_delivery
      class WebhookReplayDeliveryResponse < ArkEmail::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [ArkEmail::Models::Platform::WebhookReplayDeliveryResponse::Data]
        required :data, -> { ArkEmail::Models::Platform::WebhookReplayDeliveryResponse::Data }
        ...
        #
        #   @param data [ArkEmail::Models::Platform::WebhookReplayDeliveryResponse::Data]
        #   @param meta [ArkEmail::Models::APIMeta]
        #   @param success [Boolean, true]

        # @see ArkEmail::Models::Platform::WebhookReplayDeliveryResponse#data
        class Data < ArkEmail::Internal::Type::BaseModel
          ...
          #
          #   @param success [Boolean] Whether the replay was successful
          #
