...
module ArkEmail
  module Models
    ...
    class UsageRetrieveTenantTimeseriesParams < ArkEmail::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, ArkEmail::Models::UsageRetrieveTenantTimeseriesParams::Granularity, nil]
      optional :granularity, enum: -> { ArkEmail::UsageRetrieveTenantTimeseriesParams::Granularity }
