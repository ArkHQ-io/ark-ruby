...
module ArkEmail
  module Models
    # @see ArkEmail::Resources::Tracking#verify
    class TrackingVerifyResponse < ArkEmail::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [ArkEmail::Models::TrackingVerifyResponse::Data]
      required :data, -> { ArkEmail::Models::TrackingVerifyResponse::Data }
      ...
      #   @param data [ArkEmail::Models::TrackingVerifyResponse::Data]
      #   @param meta [ArkEmail::Models::APIMeta]
      #   @param success [Boolean, true]

      # @see ArkEmail::Models::TrackingVerifyResponse#data
      class Data < ArkEmail::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, ArkEmail::Models::TrackingVerifyResponse::Data::DNSStatus, nil]
        required :dns_status,
                 enum: -> { ArkEmail::Models::TrackingVerifyResponse::Data::DNSStatus },
                 api_name: :dnsStatus,
                 nil?: true
        ...
        #
        #   @return [ArkEmail::Models::TrackingVerifyResponse::Data::DNSRecord, nil]
        optional :dns_record,
        ...
        #
        #   @param dns_status [Symbol, ArkEmail::Models::TrackingVerifyResponse::Data::DNSStatus, nil] Current DNS verification status
        #
        ...
        #
        #   @param dns_record [ArkEmail::Models::TrackingVerifyResponse::Data::DNSRecord, nil] Required DNS record configuration

        # Current DNS verification status
        #
        # @see ArkEmail::Models::TrackingVerifyResponse::Data#dns_status
        module DNSStatus
        ...
        # @see ArkEmail::Models::TrackingVerifyResponse::Data#dns_record
