...
module ArkEmail
  module Models
    ...
    class SuppressionCreateResponse < ArkEmail::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [ArkEmail::Models::SuppressionCreateResponse::Data]
      required :data, -> { ArkEmail::Models::SuppressionCreateResponse::Data }
      ...
      #   @param data [ArkEmail::Models::SuppressionCreateResponse::Data]
      #   @param meta [ArkEmail::Models::APIMeta]
      #   @param success [Boolean, true]

      # @see ArkEmail::Models::SuppressionCreateResponse#data
