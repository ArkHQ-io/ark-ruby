...
module ArkEmail
  module Models
    # @see ArkEmail::Resources::Suppressions#retrieve
    class SuppressionRetrieveResponse < ArkEmail::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [ArkEmail::Models::SuppressionRetrieveResponse::Data]
      required :data, -> { ArkEmail::Models::SuppressionRetrieveResponse::Data }
      ...
      #   @param data [ArkEmail::Models::SuppressionRetrieveResponse::Data]
      #   @param meta [ArkEmail::Models::APIMeta]
      #   @param success [Boolean, true]

      # @see ArkEmail::Models::SuppressionRetrieveResponse#data
