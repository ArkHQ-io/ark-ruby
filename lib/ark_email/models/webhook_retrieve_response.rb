...
module ArkEmail
  module Models
    # @see ArkEmail::Resources::Webhooks#retrieve
    class WebhookRetrieveResponse < ArkEmail::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [ArkEmail::Models::WebhookRetrieveResponse::Data]
      required :data, -> { ArkEmail::Models::WebhookRetrieveResponse::Data }
      ...
      #   @param data [ArkEmail::Models::WebhookRetrieveResponse::Data]
      #   @param meta [ArkEmail::Models::APIMeta]
      #   @param success [Boolean, true]

      # @see ArkEmail::Models::WebhookRetrieveResponse#data
      class Data < ArkEmail::Internal::Type::BaseModel
        ...
        #   Subscribed events
        #
        #   @return [Array<Symbol, ArkEmail::Models::WebhookRetrieveResponse::Data::Event>]
        required :events,
                 -> { ArkEmail::Internal::Type::ArrayOf[enum: ArkEmail::Models::WebhookRetrieveResponse::Data::Event] }
        ...
        #
        #   @param events [Array<Symbol, ArkEmail::Models::WebhookRetrieveResponse::Data::Event>] Subscribed events
        #
