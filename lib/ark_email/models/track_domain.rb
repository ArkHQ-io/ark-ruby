...
module ArkEmail
  module Models
    class TrackDomain < ArkEmail::Internal::Type::BaseModel
      ...
      #
      #   @return [Boolean]
      required :ssl_enabled, ArkEmail::Internal::Type::Boolean, api_name: :sslEnabled

      # @!attribute track_clicks
      #   Whether click tracking is enabled
      #
      #   @return [Boolean]
      required :track_clicks, ArkEmail::Internal::Type::Boolean, api_name: :trackClicks

      # @!attribute track_opens
      #   Whether open tracking is enabled
      #
      #   @return [Boolean]
      required :track_opens, ArkEmail::Internal::Type::Boolean, api_name: :trackOpens
      ...
      #
      #   @return [ArkEmail::Models::TrackDomain::DNSRecord, nil]
      optional :dns_record, -> { ArkEmail::TrackDomain::DNSRecord }, api_name: :dnsRecord, nil?: true

      # @!attribute dns_status
      #   Current DNS verification status
      #
      #   @return [Symbol, ArkEmail::Models::TrackDomain::DNSStatus, nil]
      optional :dns_status, enum: -> { ArkEmail::TrackDomain::DNSStatus }, api_name: :dnsStatus, nil?: true
      ...
      #
      #   @param dns_record [ArkEmail::Models::TrackDomain::DNSRecord, nil] Required DNS record configuration
      #
      #   @param dns_status [Symbol, ArkEmail::Models::TrackDomain::DNSStatus, nil] Current DNS verification status
      #
      ...
      # Current DNS verification status
      #
      # @see ArkEmail::Models::TrackDomain#dns_status
      module DNSStatus
