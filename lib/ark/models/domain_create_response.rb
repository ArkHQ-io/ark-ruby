...
module Ark
  module Models
    ...
    class DomainCreateResponse < Ark::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Ark::Models::DomainCreateResponse::Data]
      required :data, -> { Ark::Models::DomainCreateResponse::Data }
      ...
      # @!attribute success
      #
      #   @return [Boolean, Ark::Models::DomainCreateResponse::Success]
      required :success, enum: -> { Ark::Models::DomainCreateResponse::Success }

      # @!method initialize(data:, meta:, success:)
      #   @param data [Ark::Models::DomainCreateResponse::Data]
      #   @param meta [Ark::Models::APIMeta]
      #   @param success [Boolean, Ark::Models::DomainCreateResponse::Success]

      # @see Ark::Models::DomainCreateResponse#data
      class Data < Ark::Internal::Type::BaseModel
        ...
        #
        #   @return [Ark::Models::DomainCreateResponse::Data::DNSRecords]
        required :dns_records, -> { Ark::Models::DomainCreateResponse::Data::DNSRecords }, api_name: :dnsRecords
        ...
        #
        #   @param dns_records [Ark::Models::DomainCreateResponse::Data::DNSRecords]
        #
        ...
        # @see Ark::Models::DomainCreateResponse::Data#dns_records
      ...
      # @see Ark::Models::DomainCreateResponse#success
      module Success
