...
module Ark
  module Models
    ...
    class WebhookUpdateResponse < Ark::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Ark::Models::WebhookUpdateResponse::Data]
      required :data, -> { Ark::Models::WebhookUpdateResponse::Data }
      ...
      class Data < Ark::Internal::Type::BaseModel
        ...
        #   Subscribed events
        #
        #   @return [Array<Symbol, Ark::Models::WebhookUpdateResponse::Data::Event>]
        required :events,
                 -> { Ark::Internal::Type::ArrayOf[enum: Ark::Models::WebhookUpdateResponse::Data::Event] }
        ...
        #
        #   @param events [Array<Symbol, Ark::Models::WebhookUpdateResponse::Data::Event>] Subscribed events
        #
