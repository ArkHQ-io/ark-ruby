...
module Ark
  module Models
    # @see Ark::Resources::Domains#verify
    class DomainVerifyResponse < Ark::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Ark::Models::DomainVerifyResponse::Data]
      required :data, -> { Ark::Models::DomainVerifyResponse::Data }
      ...
      # @!attribute success
      #
      #   @return [Boolean, Ark::Models::DomainVerifyResponse::Success]
      required :success, enum: -> { Ark::Models::DomainVerifyResponse::Success }

      # @!method initialize(data:, meta:, success:)
      #   @param data [Ark::Models::DomainVerifyResponse::Data]
      #   @param meta [Ark::Models::APIMeta]
      #   @param success [Boolean, Ark::Models::DomainVerifyResponse::Success]

      # @see Ark::Models::DomainVerifyResponse#data
      class Data < Ark::Internal::Type::BaseModel
        ...
        #
        #   @return [Ark::Models::DomainVerifyResponse::Data::DNSRecords]
        required :dns_records, -> { Ark::Models::DomainVerifyResponse::Data::DNSRecords }, api_name: :dnsRecords
        ...
        #
        #   @param dns_records [Ark::Models::DomainVerifyResponse::Data::DNSRecords]
        #
        ...
        # @see Ark::Models::DomainVerifyResponse::Data#dns_records
      ...
      # @see Ark::Models::DomainVerifyResponse#success
      module Success
