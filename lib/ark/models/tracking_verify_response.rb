...
module Ark
  module Models
    # @see Ark::Resources::Tracking#verify
    class TrackingVerifyResponse < Ark::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Ark::Models::TrackingVerifyResponse::Data]
      required :data, -> { Ark::Models::TrackingVerifyResponse::Data }
      ...
      # @!attribute success
      #
      #   @return [Boolean, Ark::Models::TrackingVerifyResponse::Success]
      required :success, enum: -> { Ark::Models::TrackingVerifyResponse::Success }

      # @!method initialize(data:, meta:, success:)
      #   @param data [Ark::Models::TrackingVerifyResponse::Data]
      #   @param meta [Ark::Models::APIMeta]
      #   @param success [Boolean, Ark::Models::TrackingVerifyResponse::Success]

      # @see Ark::Models::TrackingVerifyResponse#data
      class Data < Ark::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Ark::Models::TrackingVerifyResponse::Data::DNSStatus, nil]
        required :dns_status,
                 enum: -> { Ark::Models::TrackingVerifyResponse::Data::DNSStatus },
                 api_name: :dnsStatus,
                 nil?: true
        ...
        #
        #   @return [Ark::Models::TrackingVerifyResponse::Data::DNSRecord, nil]
        optional :dns_record,
        ...
        #
        #   @param dns_status [Symbol, Ark::Models::TrackingVerifyResponse::Data::DNSStatus, nil] Current DNS verification status
        #
        ...
        #
        #   @param dns_record [Ark::Models::TrackingVerifyResponse::Data::DNSRecord, nil] Required DNS record configuration

        # Current DNS verification status
        #
        # @see Ark::Models::TrackingVerifyResponse::Data#dns_status
        module DNSStatus
        ...
        # @see Ark::Models::TrackingVerifyResponse::Data#dns_record
      ...
      # @see Ark::Models::TrackingVerifyResponse#success
      module Success
        extend Ark::Internal::Type::Enum
