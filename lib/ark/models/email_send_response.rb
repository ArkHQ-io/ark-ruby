...
module Ark
  module Models
    ...
    class EmailSendResponse < Ark::Internal::Type::BaseModel
      ...
      # @!attribute success
      #
      #   @return [Boolean, Ark::Models::EmailSendResponse::Success]
      required :success, enum: -> { Ark::Models::EmailSendResponse::Success }

      # @!method initialize(data:, meta:, success:)
      #   @param data [Ark::Models::EmailSendResponse::Data]
      #   @param meta [Ark::Models::APIMeta]
      #   @param success [Boolean, Ark::Models::EmailSendResponse::Success]
      ...
      # @see Ark::Models::EmailSendResponse#success
      module Success
        extend Ark::Internal::Type::Enum
