...
module Ark
  module Models
    ...
    class WebhookCreateResponse < Ark::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Ark::Models::WebhookCreateResponse::Data]
      required :data, -> { Ark::Models::WebhookCreateResponse::Data }
      ...
      # @!attribute success
      #
      #   @return [Boolean, Ark::Models::WebhookCreateResponse::Success]
      required :success, enum: -> { Ark::Models::WebhookCreateResponse::Success }

      # @!method initialize(data:, meta:, success:)
      #   @param data [Ark::Models::WebhookCreateResponse::Data]
      #   @param meta [Ark::Models::APIMeta]
      #   @param success [Boolean, Ark::Models::WebhookCreateResponse::Success]

      # @see Ark::Models::WebhookCreateResponse#data
      class Data < Ark::Internal::Type::BaseModel
        ...
        #   Subscribed events
        #
        #   @return [Array<Symbol, Ark::Models::WebhookCreateResponse::Data::Event>]
        required :events,
                 -> { Ark::Internal::Type::ArrayOf[enum: Ark::Models::WebhookCreateResponse::Data::Event] }
        ...
        #
        #   @param events [Array<Symbol, Ark::Models::WebhookCreateResponse::Data::Event>] Subscribed events
        #
      ...
      # @see Ark::Models::WebhookCreateResponse#success
      module Success
        extend Ark::Internal::Type::Enum
