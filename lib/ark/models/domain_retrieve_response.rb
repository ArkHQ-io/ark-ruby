...
module Ark
  module Models
    # @see Ark::Resources::Domains#retrieve
    class DomainRetrieveResponse < Ark::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Ark::Models::DomainRetrieveResponse::Data]
      required :data, -> { Ark::Models::DomainRetrieveResponse::Data }
      ...
      # @!attribute success
      #
      #   @return [Boolean, Ark::Models::DomainRetrieveResponse::Success]
      required :success, enum: -> { Ark::Models::DomainRetrieveResponse::Success }

      # @!method initialize(data:, meta:, success:)
      #   @param data [Ark::Models::DomainRetrieveResponse::Data]
      #   @param meta [Ark::Models::APIMeta]
      #   @param success [Boolean, Ark::Models::DomainRetrieveResponse::Success]

      # @see Ark::Models::DomainRetrieveResponse#data
      class Data < Ark::Internal::Type::BaseModel
        ...
        #
        #   @return [Ark::Models::DomainRetrieveResponse::Data::DNSRecords]
        required :dns_records, -> { Ark::Models::DomainRetrieveResponse::Data::DNSRecords }, api_name: :dnsRecords
        ...
        #
        #   @param dns_records [Ark::Models::DomainRetrieveResponse::Data::DNSRecords]
        #
        ...
        # @see Ark::Models::DomainRetrieveResponse::Data#dns_records
      ...
      # @see Ark::Models::DomainRetrieveResponse#success
      module Success
