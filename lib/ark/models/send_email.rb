...
module Ark
  module Models
    ...
    class SendEmail < Ark::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Ark::Models::SendEmail::Data]
      required :data, -> { Ark::SendEmail::Data }
      ...
      # @!attribute success
      #
      #   @return [Boolean, Ark::Models::SendEmail::Success]
      required :success, enum: -> { Ark::SendEmail::Success }

      # @!method initialize(data:, meta:, success:)
      #   @param data [Ark::Models::SendEmail::Data]
      #   @param meta [Ark::Models::APIMeta]
      #   @param success [Boolean, Ark::Models::SendEmail::Success]

      # @see Ark::Models::SendEmail#data
      class Data < Ark::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Ark::Models::SendEmail::Data::Status]
        required :status, enum: -> { Ark::SendEmail::Data::Status }
        ...
        #
        #   @param status [Symbol, Ark::Models::SendEmail::Data::Status] Current delivery status
        #
        ...
        # Current delivery status
        #
        # @see Ark::Models::SendEmail::Data#status
        module Status
      ...
      # @see Ark::Models::SendEmail#success
      module Success
        extend Ark::Internal::Type::Enum
