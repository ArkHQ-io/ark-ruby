    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message = "Expected a #{Hash} or #{Ark::Internal::Type::BaseModel}, got #{data.inspect}"
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in Ark::FilePart unless val.filename.nil?
        ...
        def encode_content(headers, body)
          ...
          in [Ark::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [Ark::Internal::Util::JSONL_CONTENT, Enumerable] unless Ark::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | Ark::Internal::Type::FileInput]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in Ark::Internal::Util::JSON_CONTENT
          ...
          in Ark::Internal::Util::JSONL_CONTENT
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [Ark::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in Ark::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
