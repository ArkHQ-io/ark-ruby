...
module Ark
  class Client < Ark::Internal::Transport::BaseClient
    ...
    # @return [Ark::Resources::Emails]
    attr_reader :emails

    # @return [Ark::Resources::Domains]
    attr_reader :domains

    # @return [Ark::Resources::Suppressions]
    attr_reader :suppressions

    # @return [Ark::Resources::Webhooks]
    attr_reader :webhooks

    # @return [Ark::Resources::Tracking]
    ...
    def initialize(
      ...
      @emails = Ark::Resources::Emails.new(client: self)
      @domains = Ark::Resources::Domains.new(client: self)
      @suppressions = Ark::Resources::Suppressions.new(client: self)
      @webhooks = Ark::Resources::Webhooks.new(client: self)
      @tracking = Ark::Resources::Tracking.new(client: self)
    end
  end
end
