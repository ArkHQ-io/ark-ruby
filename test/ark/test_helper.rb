...
class Ark::Test::SingletonClient < Ark::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Ark::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Ark::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @ark = Ark::Test::SingletonClient.instance
  end
