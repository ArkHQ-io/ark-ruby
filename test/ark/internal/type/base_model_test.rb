...
class Ark::Test::PrimitiveModelTest < Minitest::Test
  A = Ark::Internal::Type::ArrayOf[-> { Integer }]
  H = Ark::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend Ark::Internal::Type::Union
  end

  class B < Ark::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Ark::Internal::Type::Unknown,
      Ark::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Ark::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Ark::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Ark::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Ark::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Ark::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Ark::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Ark::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Ark::Internal::Type::Boolean, true] => true,
      [Ark::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Ark::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Ark::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Ark::Internal::Type::Converter.new_coerce_state
      Ark::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Ark::Internal::Type::Converter.dump(target, input, state: state)
...
class Ark::Test::EnumModelTest < Minitest::Test
  class E0
    include Ark::Internal::Type::Enum
...
class Ark::Test::CollectionModelTest < Minitest::Test
  A1 = Ark::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Ark::Internal::Type::HashOf[Integer]

  A2 = Ark::Internal::Type::ArrayOf[H1]
  H2 = Ark::Internal::Type::HashOf[-> { A1 }]

  A3 = Ark::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Ark::Internal::Type::HashOf[Integer, nil?: true]
...
class Ark::Test::BaseModelTest < Minitest::Test
  class M1 < Ark::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Ark::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Ark::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Ark::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Ark::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Ark::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Ark::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Ark::Errors::ConversionError => e
...
class Ark::Test::UnionTest < Minitest::Test
  class U0
    include Ark::Internal::Type::Union
  ...
  class M2 < Ark::Internal::Type::BaseModel
  ...
  class M4 < Ark::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Ark::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Ark::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Ark::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Ark::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Ark::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Ark::Internal::Type::Unknown, Ark::Internal::Type::Unknown] => true,
      [Ark::Internal::Type::Boolean, Ark::Internal::Type::Boolean] => true,
      [Ark::Internal::Type::Unknown, Ark::Internal::Type::Boolean] => false,
...
class Ark::Test::MetaInfoTest < Minitest::Test
  A1 = Ark::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Ark::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
