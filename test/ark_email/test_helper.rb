...
class ArkEmail::Test::SingletonClient < ArkEmail::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: ArkEmail::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class ArkEmail::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @ark = ArkEmail::Test::SingletonClient.instance
  end
