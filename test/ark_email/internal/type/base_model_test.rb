...
class ArkEmail::Test::PrimitiveModelTest < Minitest::Test
  A = ArkEmail::Internal::Type::ArrayOf[-> { Integer }]
  H = ArkEmail::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < ArkEmail::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      ...
      ArkEmail::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => ArkEmail::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [ArkEmail::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [ArkEmail::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [ArkEmail::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = ArkEmail::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        ArkEmail::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [ArkEmail::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [ArkEmail::Internal::Type::Boolean, true] => true,
      [ArkEmail::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => ArkEmail::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        ArkEmail::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = ArkEmail::Internal::Type::Converter.new_coerce_state
      ArkEmail::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        ArkEmail::Internal::Type::Converter.dump(target, input, state: state)
...
class ArkEmail::Test::EnumModelTest < Minitest::Test
  class E0
    include ArkEmail::Internal::Type::Enum
...
class ArkEmail::Test::CollectionModelTest < Minitest::Test
  A1 = ArkEmail::Internal::Type::ArrayOf[-> { Integer }]
  H1 = ArkEmail::Internal::Type::HashOf[Integer]

  A2 = ArkEmail::Internal::Type::ArrayOf[H1]
  H2 = ArkEmail::Internal::Type::HashOf[-> { A1 }]

  A3 = ArkEmail::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = ArkEmail::Internal::Type::HashOf[Integer, nil?: true]
...
class ArkEmail::Test::BaseModelTest < Minitest::Test
  class M1 < ArkEmail::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < ArkEmail::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < ArkEmail::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, ArkEmail::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = ArkEmail::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = ArkEmail::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(ArkEmail::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue ArkEmail::Errors::ConversionError => e
...
class ArkEmail::Test::UnionTest < Minitest::Test
  class U0
    include ArkEmail::Internal::Type::Union
  ...
  class M2 < ArkEmail::Internal::Type::BaseModel
  ...
  class M4 < ArkEmail::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, ArkEmail::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < ArkEmail::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, ArkEmail::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class ArkEmail::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include ArkEmail::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [ArkEmail::Internal::Type::Unknown, ArkEmail::Internal::Type::Unknown] => true,
      [ArkEmail::Internal::Type::Boolean, ArkEmail::Internal::Type::Boolean] => true,
      [ArkEmail::Internal::Type::Unknown, ArkEmail::Internal::Type::Boolean] => false,
...
class ArkEmail::Test::MetaInfoTest < Minitest::Test
  A1 = ArkEmail::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = ArkEmail::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
