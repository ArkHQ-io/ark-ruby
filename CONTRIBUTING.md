...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/ark_email/helpers/` and `examples/` directory.
...
require_relative "../lib/ark_email"
...
```ruby
gem "ark-email", git: "https://www.github.com/ArkHQ-io/ark-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/ArkHQ-io/ark-ruby' '<path-to-repo>'
```

```ruby
gem "ark-email", path: "<path-to-repo>"
```
